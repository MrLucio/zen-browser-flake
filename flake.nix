{
  ...
  outputs = { self, nixpkgs }:
    let
	  ...
	  sha256 = "sha256:fc1e14a8e50fa375507859c4ce84b139d7bb0431771221bd932df6bd565308c1";
	};
	"generic" = {
	  url = "https://github.com/zen-browser/desktop/releases/download/${version}/zen.linux-generic.tar.bz2";
	  sha256 = "sha256:788c1d743b16e88a10226e1b2c0d440fee9061ec52eea2323b7434f5018205b5";
	};
      };
